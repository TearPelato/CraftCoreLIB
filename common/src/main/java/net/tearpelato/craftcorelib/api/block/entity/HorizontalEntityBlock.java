package net.tearpelato.craftcorelib.api.block.entity;
...
public abstract class HorizontalEntityBlock extends EntityBlock {

    public static final EnumProperty<Direction> DIRECTION = BlockStateProperties.HORIZONTAL_FACING;

    public HorizontalEntityBlock(Properties properties)
    {
        super(properties);
    }
